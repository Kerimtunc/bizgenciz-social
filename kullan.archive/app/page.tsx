...
const departmentData = {
  lisans: [
    {
      id: 1,
      bolumAdi: "Acil Yardım ve Afet Yönetimi",
      fakulte: "Bucak Sağlık Yüksekokulu",
      whatsappLinki: "https://chat.whatsapp.com/example1",
    },
    {
      id: 2,
      bolumAdi: "Acil Yardım ve Afet Yönetimi",
      fakulte: "Sağlık Bilimleri Fakültesi",
      whatsappLinki: "https://chat.whatsapp.com/example2",
    },
    {
      id: 3,
...
export default function MAKUGroupsPlatform() {
      ...
      <div className="relative min-h-[40vh] bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white shadow-2xl overflow-hidden">
        ...
        <div className="relative flex items-center justify-center min-h-[40vh] p-8">
          <div className="text-center max-w-md mx-auto">
            ...
            <h1 className="text-3xl font-bold mb-3 gradient-text-white">MAKÜ Bölüm Grupları</h1>
            <p className="text-blue-100 text-sm mb-6">Burdur Mehmet Akif Ersoy Üniversitesi</p>
