# 🎨 Shadcn UI Component Library - Modern UI Bileşen Kütüphanesi

## 📋 Özellikler
- **Radix UI Based**: Radix UI tabanlı bileşenler
- **Tailwind CSS**: Tailwind CSS ile stillendirme
...
### 2. Card Component with Header and Content
```typescript
import * as React from "react"
import { cn } from "@/lib/utils"
...
### 3. Dialog Component with Portal
```typescript
import * as React from "react"
...
### 5. Progress Component with Animation
```typescript
import * as React from "react"
...
- **CSS-in-JS**: CSS-in-JS optimizasyonu
- **Bundle Splitting**: Paket bölme
- **Code Splitting**: Kod bölme

## 📱 Accessibility Features
- **ARIA Support**: ARIA desteği
...
- **Component Variants**: Bileşen varyantları
- **Custom Styling**: Özel stillendirme
