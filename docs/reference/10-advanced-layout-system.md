# Advanced Layout System - Gelişmiş Layout Sistemi

## 🎯 Genel Bakış

Bu dosya, modern React uygulamaları için gelişmiş layout sistemi bileşenlerini içerir. Error boundary'ler, toast yönetimi, accessibility provider'lar ve global state yönetimi gibi kritik altyapı bileşenlerini kapsar.

## 🚀 Temel Özellikler

### 1. **Global Error Boundary System**
- **Error Catching**: Tüm uygulama hatalarını yakalama
- **Error Reporting**: Hata raporlama ve loglama
- **User Recovery**: Kullanıcı dostu hata çözümleri
- **Development Support**: Geliştirici modu detayları
...
### 2. **Error Toast Manager System**
- **Toast Management**: Çoklu toast yönetimi
- **Auto-close**: Otomatik kapatma sistemi
- **Position Management**: Dinamik pozisyonlama
- **Global Access**: Window objesi üzerinden erişim
...
- **Type-based Icons**: Hata türüne göre ikonlar
- **Severity Colors**: Önem seviyesine göre renkler
- **Progress Bar**: Otomatik kapatma göstergesi
...
- **SERVER_ERROR**: Sunucu hataları
- **NOT_FOUND**: Bulunamama hataları

### 2. **Severity Levels**
- **CRITICAL**: Kritik hatalar (kırmızı)
- **HIGH**: Yüksek önem (turuncu)
- **MEDIUM**: Orta önem (sarı)
- **LOW**: Düşük önem (mavi)

### 3. **Recovery Actions**
- **Retry**: Tekrar deneme
- **Reload**: Sayfa yenileme
- **Go Home**: Ana sayfaya dönme
- **Copy Details**: Hata detaylarını kopyalama
- **Report**: Destek ekibine bildirme

## 📱 Responsive Design

### 1. **Mobile-First Approach**
- **Touch-friendly**: Dokunma dostu butonlar
- **Readable Text**: Okunabilir metin boyutları
- **Proper Spacing**: Uygun boşluklar
...
- **State Management**: aria-checked, aria-expanded
...
- **Keyboard Shortcuts**: ESC to close, Enter to activate
...
### 1. **Memory Management**
- **Toast Cleanup**: Automatic toast removal
- **Event Cleanup**: Proper event listener cleanup
- **State Optimization**: Efficient state updates
- **Component Unmounting**: Proper cleanup on unmount
...
describe('ErrorToast', () => {
  it('has proper ARIA attributes', () => {
    render(
      <ErrorToast
        error={{ type: 'NETWORK', severity: 'HIGH', message: 'Test' }}
        onClose={jest.fn()}
      />
    );
...
Bu layout sistemi, modern React uygulamaları için güvenilir, erişilebilir ve performanslı bir altyapı sağlar. 